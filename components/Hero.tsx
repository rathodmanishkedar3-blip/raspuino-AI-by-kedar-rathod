...
export const Hero: React.FC = () => {
  return (
    <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gray-500/10 rounded-full blur-[120px] -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 bg-gray-900/50 border border-gray-800 rounded-full px-3 py-1 mb-8 backdrop-blur-sm">
            <span className="flex h-2 w-2 rounded-full bg-white/80 animate-pulse"></span>
        ...
        <div className="mt-20 mx-auto max-w-3xl glass-panel rounded-xl overflow-hidden shadow-2xl border border-gray-800">
          <div className="bg-gray-900/80 px-4 py-2 flex space-x-2 border-b border-gray-800">
            <div className="w-3 h-3 rounded-full bg-gray-700/50 border border-gray-600/50"></div>
            <div className="w-3 h-3 rounded-full bg-gray-700/50 border border-gray-600/50"></div>
            <div className="w-3 h-3 rounded-full bg-gray-700/50 border border-gray-600/50"></div>
          </div>
          <div className="p-6 font-mono text-sm text-gray-300 overflow-x-auto">
            ...
            <div className="text-gray-400 mt-2">
              > Optimizing for ARM64... <span className="text-white">Done (120ms)</span><br/>
              > Compressing weights... <span className="text-white">Done (45ms)</span><br/>
              > Pushing to 1,240 devices... <span className="text-white animate-pulse">Syncing...</span>
            </div>
          </div>
        </div>
      </div>
